...
- **Failed native landings no longer strand transitions or discard unrelated size feedback.** Failed synchronous placement attempts invalidate their unconfirmed presentation before retrying, preserve ordinary primary feedback when parking fails, and release departing ghost cloaks after their thumbnail has already been dropped.
