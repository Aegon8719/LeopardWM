...
- **Failed native landings no longer strand transitions or discard unrelated size feedback.** Failed synchronous placement attempts invalidate their unconfirmed presentation before retrying, while empty filtered batches retain it until a later verified landing. Ordinary primary feedback survives parking failures, and departing ghost cloaks release after their thumbnail has already been dropped.
